    ...
    <main className="min-h-screen bg-[#030308] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 pt-8 pb-20">
        <div className="text-center mb-12 max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black mb-4 leading-none">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-3 sm:gap-8 text-center">
